        ...
        >
          ...
          <Tooltip title="Theme">
            <IconButton onClick={toggleMode} color="primary">
              {mode === "dark" ? (
                <HiOutlineMoon sx={{ fontSize: "25px" }} />
              ) : (
      ...
      >
        ...
        <Link href="/products">
          <Typography
            ...
            sx={{
              borderBottom: `${
                router.asPath === "/products" && "2px solid #998e76"
              }`,
              cursor: "pointer",
              px: "6px",
              ":hover": { color: "#B2B2B2" },
        ...
        <Link href="/aboutUs">
          <Typography
            ...
            sx={{
              borderBottom: `${
                router.asPath === "/aboutUs" && "2px solid #998e76"
              }`,
              cursor: "pointer",
              px: "6px",
              ":hover": { color: "#B2B2B2" },
        ...
        <Link href="/contactUs">
          <Typography
            ...
            sx={{
              borderBottom: `${
                router.asPath === "/contactUs" && "2px solid #998e76"
              }`,
              cursor: "pointer",
              px: "6px",
              ":hover": { color: "#B2B2B2" },
              ...
              <Link href="/products">
                ...
                >
                  <HiOutlineTag
                    style={{
                      color: `${
                        router.asPath === "/products" ? "black" : "primary"
                      }`,
                      fontSize: "25px",
                    }}
                  />
              ...
              <Link href="/aboutUs">
                ...
                >
                  <HiOutlineInformationCircle
                    style={{
                      color: `${
                        router.asPath === "/aboutUs" ? "black" : "primary"
                      }`,
                      fontSize: "25px",
                    }}
                  />
              ...
              <Link href="/contactUs">
                <ListItemButton
                  sx={{
                    ...
                    cursor: "pointer",
                    backgroundColor: `${
                      router.asPath === "/contactUs" && "#deac7c"
                    }`,
                  }}
                >
                  <HiOutlineAnnotation
                    style={{
                      color: `${
                        router.asPath === "/contactUs" ? "black" : "primary"
                      }`,
                      fontSize: "25px",
                    }}
                  />
